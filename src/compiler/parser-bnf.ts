        ...
        },//继承,虽然文法是允许继承任意类型,但是在语义分析的时候再具体决定该class能不能被继承
        {
            "function_definition:function id template_declare ( parameter_declare ) { statements }": {
                action: function ($, s): VariableDescriptor {
                    ...
                    ret[id] = { variable: 'val', type: { FunctionType: { namespace: namespaceforParser, capture: {}, _arguments: parameter_declare, body: statements, templates: template_declare } } };
                    return ret;
                }
            }
        },//函数定义语句，同样太长，不列表,返回值类型可以不声明，自动推导,lambda就不用写返回值声明
        {
            "function_definition:function id template_declare ( parameter_declare ) : type { statements }": {
                action: function ($, s): VariableDescriptor {
                    ...
                    let ret: VariableDescriptor = JSON.parse("{}");//为了生成的解析器不报红
                    ret[id] = { variable: 'val', type: { FunctionType: { namespace: namespaceforParser, capture: {}, _arguments: parameter_declare, body: statements, templates: template_declare, retType: ret_type } } };
                    return ret;
                }
            }
        },//函数定义语句，同样太长，不列表
        {
            "function_definition:function id template_declare ( parameter_declare ) : type { native }": {
                action: function ($, s): VariableDescriptor {
                    ...
                    let ret_type = $[7] as TypeUsed;
                    let ret: VariableDescriptor = JSON.parse("{}");//为了生成的解析器不报红
                    ret[id] = { variable: 'val', type: { FunctionType: { namespace: namespaceforParser, capture: {}, _arguments: parameter_declare, isNative: true, templates: template_declare, retType: ret_type } } };
                    return ret;
                }
            }
        },//函数定义语句，native函数
                ...
                action: function ($, s): { [key: string]: ExtensionMethod } {
                    ...
                    return {
                        [id]: {
                            ...
                            fun: { namespace: namespaceforParser, capture: {}, _arguments, isNative: false, body }
                        }
                    };
                }
            }
                ...
                action: function ($, s): { [key: string]: ExtensionMethod } {
                    ...
                    return {
                        [id]: {
                            ...
                            thisName,
                            extendFunName: $[2] as string,
                            fun: { namespace: namespaceforParser, capture: {}, _arguments, isNative: false, retType, body }
                        }
                    };
                }
            }
        ...
        },//type可以是一个base_type templateSpecialization
        {
            "functionType:template_definition ( parameter_declare ) => type": {
                ...
                action: function ($, s): TypeUsed {
                    ...
                    // return { FunctionType: {namespace: namespaceforParser, capture: {}, templates: template_definition, _arguments: parameter_declare, retType: ret_type } };
                }
            }
        },//泛型函数类型
        {
            "functionType:( parameter_declare ) => type": {
                ...
                action: function ($, s): TypeUsed {
                    ...
                    return { FunctionType: { namespace: namespaceforParser, capture: {}, _arguments: parameter_declare, retType: ret_type } };
                }
            }
        },//函数类型
        {
        ...
        },//set
        {
            "class_unit:basic_type ( parameter_declare )  { statements }": {
                action: function ($, s): [{ [key: string]: FunctionType }] {
                    ...
                    let functionType: FunctionType = { namespace: namespaceforParser, capture: {}, _construct_for_type: basic_type.PlainType!.name, _arguments: parameter_declare, body: statements, retType: { PlainType: { name: 'void' } } };
        ...
        },//this是一个object
        {
            "object:template_definition ( parameter_declare ) => { statements }": {
                action: function ($, s): ASTNode {
                    ...
                    //     userTypeDictionary.delete(t);
                    // }
                    // return { desc: "ASTNode", immediate: { functionValue: {namespace: namespaceforParser, capture: {}, _arguments: $[2] as VariableDescriptor, body: $[6] as Block, templates: $[0] as string[] } } };
                }
            }
        },//模板lambda
        {
            "object:( parameter_declare ) => { statements }": {
                action: function ($, s): ASTNode {
                    return { desc: "ASTNode", immediate: { functionValue: { namespace: namespaceforParser, capture: {}, _arguments: $[1] as VariableDescriptor, body: $[5] as Block } } };
                }
            }
        },//lambda
        /**
